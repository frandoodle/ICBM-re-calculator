...
PercentageDifference
```
The error value from `script_re` (the r~e~ calculator implementation in the standalone script) is the same as from `test_re` (the r~e~ calculator implementation in this R notebook), meaning our icbm_calculate_re.r implementation works as intended.
