...
This leaves us with a list of site data tables that we will pass iteratively into `run_icbm`.
...
This can be done by passing the parameters to override directly into the `run_icbm` wrapper function.
