...
This function runs the model, finds the mean r_{e} between years, and returns that value.
Therefore, by passing this function to `optim`, we will be asking it to minimize the value of r_{e}.
