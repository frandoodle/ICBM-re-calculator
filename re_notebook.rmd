...
<span style="color: red;">
Question for Holos team: In Eq. 2.2.1-15, SoilTemp_d was set to 0 if JulianDay = 1; what does this make SoilTemp_dprev on JulianDay = 1?
</span>
...
In Holos, re_crop is calculated daily and then averaged annually.
```{r}
...
```
where
ReferenceAdjustment is the calibration factor for a bare-fallow treatment considering a soil thickness of 25 cm (Uppsala, Sweden), and
