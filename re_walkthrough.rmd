...
The climate data should have these mandatory columns: `Year`, `JulianDay`, `MeanDailyAirTemperature`, `MeanDailyPrecipitation`, and `MeanDailyPET`.
...
iag <- rep(977,length(unique(holos_nasa_climate$Year))) #aboveground young
ibg <- rep(288,length(unique(holos_nasa_climate$Year))) #belowground young
iman <- rep(88,length(unique(holos_nasa_climate$Year))) #manure
