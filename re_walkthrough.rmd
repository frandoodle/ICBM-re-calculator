...
```{r}
WaterContent_return <- calculateWaterContent(SoilOrganicC_Percent = daily_input_test$SoilOrganicC_Percent[[1]],
																						 ClayContent = daily_input_test$ClayContent[[1]],
																						 SandContent = daily_input_test$SandContent[[1]])
WaterContent_return
