...
<!-- We need to handle situations where different lowest depths are measured within the same treatment/site. This will mean that multiple estimates of the DSM difference (DSM initial C - first measured C) will need to be obtained for different depth ranges. -->
